...
#define RAVE_EEPROM_DDS_PATH "/dev/dds-eeprom"
...
typedef enum {
	...
	RAVE_EEPROM_DDS_PAGE_MAX
} rave_eeprom_dds_page_t;

const char *rave_eeprom_dds_page_to_string(rave_eeprom_dds_page_t page_number);
typedef void (rave_eeprom_dds_page_foreach_func)(rave_eeprom_dds_page_t page_number, void *user_data);
