...
extern char __dtb_imx51_zii_mezz_start[];

ENTRY_FUNCTION(start_imx51_zii_mezz, r0, r1, r2)
{
	void *fdt;
	...
	fdt = __dtb_imx51_zii_mezz_start - get_runtime_offset();

	imx51_barebox_entry(fdt);
}

static noinline void zii_mezz_entry(void)
{
...
ENTRY_FUNCTION(start_imx51_zii_mezz_xload, r0, r1, r2)
{
	imx5_cpu_lowlevel_init();
